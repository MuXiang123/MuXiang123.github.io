...
![img-20230306195432035](img/netty入门/img-20230306195432035.png)
...
![img-20230307193519223](img/netty入门/img-20230307193519223.png)

于是pipeline就出现了，pipeline相当于处理器的容器。初始化channel时，把channelHandler按顺序装在pipeline中，就可以实现按序执行channelHandler了。

![img-20230307193528870](img/netty入门/img-20230307193528870.png)
...
![img-20230307193637688](img/netty入门/img-20230307193637688.png)

通过类图，ChannelHandlerContext是一个接口，下面有三个实现类。

![img-20230307193702314](img/netty入门/img-20230307193702314.png)

### 9、EventLoopGroup

![img-20230307193734269](img/netty入门/img-20230307193734269.png)
